...
iconimage = os.path.join(addon_path,"media/chillicon.png")
...
iconimage = os.path.join(addon_path,"media/electroicon.png")
liz=xbmcgui.ListItem(name, iconImage=iconimage,thumbnailImage=iconimage)
liz.setInfo( type="audio", infoLabels={ "Title": name } )
xbmcplugin.addDirectoryItem(pluginHandle, url, liz)
...
iconimage = os.path.join(addon_path,"media/proghouseicon.png")
liz=xbmcgui.ListItem(name, iconImage=iconimage,thumbnailImage=iconimage)
liz.setInfo( type="audio", infoLabels={ "Title": name } )
xbmcplugin.addDirectoryItem(pluginHandle, url, liz)
...
iconimage = os.path.join(addon_path,"media/progressiveicon.png")
liz=xbmcgui.ListItem(name, iconImage=iconimage,thumbnailImage=iconimage)
liz.setInfo( type="audio", infoLabels={ "Title": name } )
xbmcplugin.addDirectoryItem(pluginHandle, url, liz)
...
iconimage = os.path.join(addon_path,"media/psyicon.png")
liz=xbmcgui.ListItem(name, iconImage=iconimage,thumbnailImage=iconimage)
liz.setInfo( type="audio", infoLabels={ "Title": name } )
xbmcplugin.addDirectoryItem(pluginHandle, url, liz)
...
iconimage = os.path.join(addon_path,"media/technoicon.png")
liz=xbmcgui.ListItem(name, iconImage=iconimage,thumbnailImage=iconimage)
liz.setInfo( type="audio", infoLabels={ "Title": name } )
xbmcplugin.addDirectoryItem(pluginHandle, url, liz)
